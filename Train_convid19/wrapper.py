...
class AmGANet_2DWrapper(pl.LightningModule):

    def __init__(self, args, task_name="Covid19_X"):
        
        super(AmGANet_2DWrapper, self).__init__()

        from model.config import get_config
        parser = argparse.ArgumentParser()
        parser.add_argument('--cfg', type=str,
                            metavar="FILE",
                            default="/home/y1408/CAI/third_paper/AmGANet/model/configs/AmGANet.yaml",
        ...
        self.model = AmGANet_2D(configs, task_name, num_classes=1)
        self.model.load_from(configs)

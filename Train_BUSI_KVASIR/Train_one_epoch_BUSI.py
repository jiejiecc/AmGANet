...
import os
import time
from Train_BUSI_KVASIR.utils import *
import Train_BUSI_KVASIR.Config_BUSI as config
import warnings
...
#=================================================================================
##################################################################################
def train_one_epoch(loader, model, criterion, optimizer, writer, epoch, lr_scheduler, model_type, logger, loss_selection= False):
    ...
    for i, (sampled_batch, names) in enumerate(loader, 1):
        ...
        preds = model(images)
        if loss_selection == True:
            
            out_loss = structure_loss(preds, masks.float())  # Loss
        elif  loss_selection == False:

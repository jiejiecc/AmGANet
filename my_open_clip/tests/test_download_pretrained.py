...
class DownloadPretrainedTests(unittest.TestCase):
    ...
    def test_download_pretrained_from_hfh(self, urllib):
        model, _, preprocess = my_open_clip.create_model_and_transforms('hf-hub:hf-internal-testing/tiny-open-clip-model')
        tokenizer = my_open_clip.get_tokenizer('hf-hub:hf-internal-testing/tiny-open-clip-model')
